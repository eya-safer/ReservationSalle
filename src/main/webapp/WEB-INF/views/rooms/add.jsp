    ...
    <body>
        ...
        <div class="container">
            <div class="form-container">
                ...
                <h1 class="page-title"><i class="fa-solid fa-plus-circle"></i> Add New Room</h1>
                    ...
                    <% } %>
                        ...
                        <form action="${pageContext.request.contextPath}/rooms/add" method="post">
                            <div class="form-group">
                                ...
                                <input type="text" id="name" name="name" required placeholder="e.g. Meeting Room A">
                            </div>

                            <div class="form-group">
                                <label for="capacity">Capacity (people) <span class="required">*</span></label>
                                <input type="number" id="capacity" name="capacity" required min="1" value="10">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="imageUrl" name="imageUrl" placeholder="images/room1.jpg">
                            </div>
                            ...
                            <div class="btn-group">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="fa-solid fa-check"></i> Create Room
                                </button>
                            </div>
                        </form>
            </div>
