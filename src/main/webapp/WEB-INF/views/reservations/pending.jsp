<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ page import="com.coworking.model.Reservation, java.util.List, java.time.format.DateTimeFormatter" %>
        ...
        <head>
            ...
            <title>Admin - Pending Reservations - SPACE</title>
        ...
        <body>
            ...
            <div class="container">
                ...
                <div class="view-tabs mb-4">
                    ...
                    <a href="${pageContext.request.contextPath}/reservations/pending" class="btn btn-primary me-2">
                ...
                <% List<Reservation> reservations = (List<Reservation>) request.getAttribute("reservations");
                        ...
                        <% } else { %>
                            <div class="empty-state">
                                ...
                                <p>There are currently no reservations waiting for approval.</p>
                            </div>
                            <% } %>
            </div>
        </body>
